...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bchsuite/bchutil/coinset)
...
```bash
$ go get -u github.com/bchsuite/bchutil/coinset
```
